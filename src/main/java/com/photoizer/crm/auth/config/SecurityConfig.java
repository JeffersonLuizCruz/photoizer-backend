    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/v1/admin/**", "/api/v1/configuracoes/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET, "/api/v1/financeiro/**").authenticated()
               ...
               .requestMatchers(HttpMethod.GET, "/api/v1/fotografos/**").authenticated()
               .requestMatchers("/api/v1/fotografos/**").hasRole("ADMIN")
               .requestMatchers(HttpMethod.GET, "/api/v1/parceiros/**").authenticated()
               .requestMatchers("/api/v1/parceiros/**").hasRole("ADMIN")
               .requestMatchers(HttpMethod.GET, "/api/v1/repasses/**").hasRole("ADMIN")
                .requestMatchers("/api/v1/repasses/**").hasRole("ADMIN")
                .requestMatchers("/api/v1/agendamentos/*/fotografos/**").authenticated()
